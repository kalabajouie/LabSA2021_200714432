Module Module1
    'El servicio SOAP se agrega como Referencia de Servicio
    ...
    Private Function suma(v1 As Decimal, v2 As Decimal) As Decimal
        'funcion que llama al metodo add del WS para hacer una suma
    ...
    Private Function resta(v1 As Decimal, v2 As Decimal) As Decimal
        'funcion que llama al metodo substract del WS para hacer una resta
    ...
    Private Function multiplicacion(v1 As Decimal, v2 As Decimal) As Decimal
        'funcion que llama al metodo multiply del WS para hacer una multiplicacion
    ...
    Private Function division(v1 As Decimal, v2 As Decimal) As Decimal
        'funcion que llama al metodo divide del WS para hacer una division
